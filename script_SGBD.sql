...
CREATE TABLE objectif(
   Id_objectif INT GENERATED BY DEFAULT AS IDENTITY,
   type INT,
...
CREATE TABLE contributeur_ice_(
   Id_contributeur_ice_ INT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE Zone(
   idZone INT GENERATED BY DEFAULT AS IDENTITY,
   posZone_x INT,
   posZone_y INT,
...
CREATE TABLE passageSecret(
   idPassage INT GENERATED BY DEFAULT AS IDENTITY,
   difficultées INT,
